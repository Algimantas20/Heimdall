...
public:
    ...
    H_BMP_280(int8_t cspin, SPIClass *theSPI = &SPI) : Adafruit_BMP280(cspin, theSPI) {}
    H_BMP_280(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin) : Adafruit_BMP280(cspin, mosipin, misopin, sckpin) {}
